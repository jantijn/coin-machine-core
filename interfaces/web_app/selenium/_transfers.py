...
def go_to_search_the_transfer_market(driver):
    go_to_search_the_transfer_market_button = utils.get_element(driver, GO_TO_SEARCH_THE_TRANSFER_MARKET_BUTTON)
    go_to_search_the_transfer_market_button.safe_click()


def go_to_transfer_targets(driver):
    go_to_transfer_targets_button = utils.get_element(driver, GO_TO_TRANSFER_TARGETS_BUTTON)
